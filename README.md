...
- :school: I am a `Systems Engineer` and `Junior Web Dev` at  [UNEFA UNIVERSITY](http://www.unefa.edu.ve).
- :technologist: I love using Software as a solution for every `Problem`.
- :computer: I am a competitive programmer at `Codeforces`, `Atcoder`, `Leetcode`, `Codechef`, `Google Contests`.
- :student: I’m currently learning `Digital Marketing` 
...
**JesusS2001/JesusS2001** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
